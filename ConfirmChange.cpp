...
IMPLEMENT_DYNAMIC(ConfirmChange, CDialogEx)

ConfirmChange::ConfirmChange(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_ConfirmChange, pParent)
	, c_name(_T(""))
	, c_wage(0)
{
...
void ConfirmChange::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(ConfirmChange, CDialogEx)
	ON_BN_CLICKED(IDOK, &ConfirmChange::OnBnClickedOk)
END_MESSAGE_MAP()


// ConfirmChange 消息处理程序


BOOL ConfirmChange::OnInitDialog()
{
...
void ConfirmChange::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
