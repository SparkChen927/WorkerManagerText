...
IMPLEMENT_DYNAMIC(ConfirmDelete, CDialogEx)

ConfirmDelete::ConfirmDelete(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_ConfirmDelete, pParent)
{
...
void ConfirmDelete::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(ConfirmDelete, CDialogEx)
	ON_BN_CLICKED(IDOK, &ConfirmDelete::OnBnClickedOk)
END_MESSAGE_MAP()


// ConfirmDelete 消息处理程序





BOOL ConfirmDelete::OnInitDialog()
{
...
void ConfirmDelete::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	ifstream ifs(FILENAME);//打开文件
