...
IMPLEMENT_DYNAMIC(SellManager, CDialogEx)

SellManager::SellManager(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SellManager, pParent)
{
...
void SellManager::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(SellManager, CDialogEx)
	ON_BN_CLICKED(IDOK, &SellManager::OnBnClickedOk)
END_MESSAGE_MAP()
...
BOOL SellManager::OnInitDialog()
{
	...
	while (!ifs.eof())//未读取完毕
	{
		...
		int sm_wage = wage->n_wage + tmp.wage;
...
void SellManager::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
